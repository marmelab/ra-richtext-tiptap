...
export const RichTextInputLevelSelect = (props: RichTextInputLevelSelectProps) => {
	...
	const handleClickListItem = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
	...
	const selectedOption = options.find((option) => isSelectedOption(editor, option)) || options[0];
	...
	return (
		<>
			...
			<Menu anchorEl={anchorElement} open={Boolean(anchorElement)} id="level-menu" onClose={handleClose}>
